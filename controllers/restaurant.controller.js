...
exports.createRestaurant = async (req, res) => {
  ...
  try {
    ...
    if(restaurantObj.name== undefined || restaurantObj.description==undefined||restaurantObj.category==undefined||
      restaurantObj.imageURL==undefined||restaurantObj.location==undefined || restaurantObj.phone==undefined
       ||restaurantObj.rating==undefined){
     res.status(500).send({
    ...
    return res.status(200).send(restaurantResp)
